...
describe Query do
  let(:my_query) { Query.new("1999 Miata cars", "1000", "2000", "1") }
  ...
  context '#url' do
    it "creates a url without a min" do
      new_query = Query.new("1999 Miata cars", "nil", "2000", "1")
    ...
    it "creates a url without a max" do
      new_query = Query.new("1999 Miata cars", "1000", "nil", "1")
    ...
    it "creates a url without a pic" do
      new_query = Query.new("1999 Miata cars", "1000", "2000", "nil")
