...
describe 'Post' do
  ...
  it "creates a hash based on the data sent to it" do
    initialize_post = Post.new([" Oct 29", "1999 Dodge Ram 1500 Quad Cab 5.9L V8", " $5995", " (milpitas)", " cars & trucks - by dealer", "http://sfbay.craigslist.org/sby/ctd/3372616665.html", "3374731585"])
